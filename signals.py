...
# Twelve Data currently documents 1min and 5min intraday
# intervals. 2min and 3min are built locally from 1min candles.
TIMEFRAME_SETTINGS = {
    "1M": {
        "api_interval": "1min",
        "minutes": 1,
...
def get_signal(
    ...
    # Twelve Data supports XAU/USD and XAU/CHF
    # using the slash-form symbol.
    symbol = display_pair
